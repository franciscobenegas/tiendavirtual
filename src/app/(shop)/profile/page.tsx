...
export default async function ProfilePage() {
  ...
  return (
    <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 mt-10 mb-20 ml-20">
      <Image
        className="object-scale-down object-center w-full h-56 bg-slate-300"
      ...
      <div className="flex items-center px-6 py-3 bg-gray-900">
        ...
        <button className=" hover:text-black w-full group relative h-12  overflow-hidden rounded-2xl bg-slate-400 text-lg font-bold text-white">
          Cambiar Logo
      ...
      <div className="px-6 py-4">
        ...
        <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
          ...
          <h1 className="px-2 text-sm">Paraguay</h1>
        </div>
